...
par.n = 5;     % number of relevant variables from which target is generated
%par.seed = 1;   % random number generator seed, if not given, generated from time
par.sets = 10;   % how many data sets to generate
par.testFraction = 0; % fraction of each set written to test file

% used by nonlinear dependency generation
par.L = 5;     % number of functions added together to construct the target
...
par.mixedType  = 0.0;     % discretize this fraction of the input variables
