...
TESTFILES = test/partitionsequence_test.hpp test/argparse_test.hpp test/datadefs_test.hpp test/stochasticforest_test.hpp test/rootnode_test.hpp test/node_test.hpp test/treedata_test.hpp test/splitter_test.hpp
