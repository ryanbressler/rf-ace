...
SOURCEFILES = src/stochasticforest.cpp src/rootnode.cpp src/node.cpp src/splitter.cpp src/treedata.cpp src/mtrand.cpp src/datadefs.cpp src/partitionsequence.cpp
STATICFLAGS = -static-libgcc -static
TESTFILES = test/argparse_test.hpp test/datadefs_test.hpp test/node_test.hpp test/treedata_test.hpp test/partitionsequence_test.hpp test/splitter_test.hpp
