...
rf_ace: src/rf_ace.cpp src/randomforest.cpp src/GBT.cpp src/node.cpp src/treedata.cpp src/datadefs.cpp
	$(COMPILER) $(CFLAGS) $(RF_ACE_LIBS) src/rf_ace.cpp src/randomforest.cpp src/GBT.cpp src/node.cpp src/treedata.cpp src/datadefs.cpp -o bin/rf_ace
