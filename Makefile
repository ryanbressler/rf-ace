...
rf_ace: src/rf_ace.cpp src/randomforest.cpp src/GBT.cpp src/node.cpp src/treedata.cpp src/mtrand.cpp src/datadefs.cpp
	$(COMPILER) $(CFLAGS) src/rf_ace.cpp src/randomforest.cpp src/GBT.cpp src/node.cpp src/treedata.cpp src/mtrand.cpp src/datadefs.cpp -o bin/rf_ace $(RF_ACE_LIBS)
