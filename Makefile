...
GBT_test: src/GBT_test.cpp src/getopt_pp.cpp src/GBT.cpp src/node.cpp src/treedata.cpp src/mtrand.cpp src/datadefs.cpp
	$(COMPILER) $(CFLAGS) src/GBT_test.cpp src/getopt_pp.cpp src/GBT.cpp src/node.cpp src/treedata.cpp src/mtrand.cpp src/datadefs.cpp -o bin/GBT_test
