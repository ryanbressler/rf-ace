rface.train <-
function(trainData, target, featureWeights = vector(length=0), forestType = "RF", nTrees = 100, mTry = 10, nodeSize = 3, nMaxLeaves = 0, shrinkage = 0.01, noNABranching = FALSE, nThreads = 1) {
